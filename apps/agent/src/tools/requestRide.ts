...
export const requestRideTool = tool(
  ...
  {
    name: 'requestRide',
    description: 'Initiate a draft ride booking request once passenger details and vehicle selection are provided.',
    schema: z.object({
      ...
      passengerPhone: z.string().describe('The passenger phone number (e.g. +84...)'),
