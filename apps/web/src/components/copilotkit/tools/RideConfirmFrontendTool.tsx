...
export function RideConfirmFrontendTool({ trips, setTrips }: RideConfirmFrontendToolProps) {
  const resolveRef = useRef<((value: any) => void) | null>(null);

  useFrontendTool({
    name: 'showRideConfirm',
    description: 'Display the final ride request details (pickup, destination, vehicle, passenger name, phone, price) to the user for approval or cancellation.',
    parameters: z.object({
